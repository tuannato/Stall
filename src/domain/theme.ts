...
export const FONT_STACKS = [
    // Each stack's first face is self-hosted (Inter, JetBrains Mono, Lora:
...
export const DEFAULT_THEME: DecodedTheme = {
    ...
    shape: {
        ...
        colsM: '44px minmax(0, 1fr) auto',
        colsD: 'var(--s-icon-d) minmax(0, 1fr) auto 16px',
        areasM3: '"ic name" "price price"',
        colsM3: '44px minmax(0, 1fr)',
        itemsD: 'minmax(0, 1fr)',
    ...
    [
        NEO_CITY_THEME_ID,
        {
            ...
            shape: {
                ...
                iconClip: 'polygon(0 0, 100% 0, 100% 74%, 74% 100%, 0 100%)',
                hero: '120px',
                heroRadius: '0px',
                priceSize: '26px',
                priceWeight: '800',
